...
Small steps that survive contact with life: if-then pre-wiring and gentle follow-through on open ones.

## Requirements

### Requirement: Pre-wire a step with an if-then plan
...
### Requirement: Follow through on open steps
