...
The living spec made tangible: life areas under a cap, intentions as testable when/I markers, and priorities that map to red lines / would-likes / bonuses.

## Requirements

### Requirement: Life areas with a cap
...
### Requirement: Intention as a testable marker
...
### Requirement: Intentions per area are capped
