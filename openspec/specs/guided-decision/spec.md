# guided-decision Specification

## Purpose

The heart of the app: a decision walked through exploration, widened options, debiasing, compass alignment, and a valid structured outcome — never a partial one.
