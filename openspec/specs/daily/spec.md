...
Today's light surface: quick captures and the open small steps, without streaks, scores, or guilt.

## Requirements

### Requirement: Capture a quick note locally
...
### Requirement: A light daily surface, no streaks
...
### Requirement: Captures are exported and erasable
