...
- [x] 3.3 Live: add a step, pre-wire an if-then, then mark it done from home   — verified on-screen: if-then anchored ("C'est ancré"), step listed on home, marked "Fait" and it left the open list
